        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    ActionTime = table.Column<DateTime>(type: "timestamp", nullable: true),
                    LogDetail = table.Column<string>(type: "text", unicode: false, maxLength: 4000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateBy = table.Column<string>(type: "text", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    Status = table.Column<string>(type: "text", unicode: false, maxLength: 1000, nullable: true),
                    Description = table.Column<string>(type: "text", unicode: false, maxLength: 1000, nullable: true),
                    InsertDate = table.Column<DateTime>(type: "timestamp", nullable: true),
                    TemplateBody = table.Column<string>(type: "text", unicode: false, nullable: true),
                    Subject = table.Column<string>(type: "text", unicode: false, maxLength: 1000, nullable: true),
                    ToRecipients = table.Column<string>(type: "text", unicode: false, maxLength: 1000, nullable: true),
                    CC = table.Column<string>(type: "text", unicode: false, maxLength: 1000, nullable: true),
                    BCC = table.Column<string>(type: "text", unicode: false, maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EventsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    EventsName = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    ParameterId = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true),
                    DisplayName = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true),
                    Description = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true),
                    ...
                    Type = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    OfferId = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true),
                    OfferName = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true),
                    CreateDate = table.Column<DateTime>(type: "timestamp", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanId = table.Column<Guid>(type: "uuid", nullable: false),
                    OfferAttributeId = table.Column<int>(type: "int", nullable: false),
                    DisplayName = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: false),
                    IsEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    Type = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Isactive = table.Column<bool>(type: "boolean", nullable: false),
                    SuccessStateEmails = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true),
                    FailureStateEmails = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true),
                    CreateDate = table.Column<DateTime>(type: "timestamp", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventId = table.Column<int>(type: "int", nullable: false),
                    EventsName = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: false),
                    CopyToCustomer = table.Column<bool>(type: "boolean", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    PlanId = table.Column<string>(type: "text", unicode: false, maxLength: 100, nullable: true),
                    Description = table.Column<string>(type: "text", unicode: false, maxLength: 500, nullable: true),
                    DisplayName = table.Column<string>(type: "text", unicode: false, maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    PlanAttributeId = table.Column<int>(type: "int", nullable: false),
                    Value = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    Name = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfferAttributeID = table.Column<int>(type: "int", nullable: false),
                    DisplayName = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: false),
                    Type = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: false),
                    ValueType = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: false),
                    ...
                    CreateDate = table.Column<DateTime>(type: "timestamp", nullable: true),
                    FromList = table.Column<bool>(type: "boolean", nullable: false),
                    ValuesList = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: false),
                    Max = table.Column<int>(type: "int", nullable: false),
                    Min = table.Column<int>(type: "int", nullable: false),
                    HTMLType = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    EmailAddress = table.Column<string>(type: "text", unicode: false, maxLength: 100, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp", nullable: true),
                    FullName = table.Column<string>(type: "text", unicode: false, maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ValueTypeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    ValueType = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true),
                    CreateDate = table.Column<DateTime>(type: "timestamp", nullable: true),
                    HTMLType = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionStatus = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    Dimension = table.Column<string>(type: "text", unicode: false, maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    UserEmail = table.Column<string>(type: "text", unicode: false, maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionStatus = table.Column<string>(type: "text", unicode: false, maxLength: 50, nullable: true),
                    AMPPlanId = table.Column<string>(type: "text", unicode: false, maxLength: 100, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: true),
                    ...
                    PurchaserEmail = table.Column<string>(type: "text", unicode: false, maxLength: 225, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestJson = table.Column<string>(type: "text", unicode: false, maxLength: 500, nullable: true),
                    ResponseJson = table.Column<string>(type: "text", unicode: false, maxLength: 500, nullable: true),
                    StatusCode = table.Column<string>(type: "text", unicode: false, maxLength: 100, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp", nullable: true),
                    CreatedBy = table.Column<int>(type: "int", nullable: false),
                    SubscriptionUsageDate = table.Column<DateTime>(type: "timestamp", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    SubscriptionID = table.Column<int>(type: "int", nullable: true),
                    Attribute = table.Column<string>(type: "text", unicode: false, maxLength: 20, nullable: true),
                    OldValue = table.Column<string>(type: "text", unicode: false, maxLength: 50, nullable: true),
